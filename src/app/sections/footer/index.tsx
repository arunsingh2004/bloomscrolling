...
const ghHref = "https://github.com/arunsingh2004/";
      ...
      <footer className={s.footer}>
        ...
        <div className={s.links}>
          ...
          <div>
            ...
            <Link className="link" href="" target="_blank" rel="noreferrer">
              say hi to me
            </Link>
          </div>
          <div>
    ...
    <>
      <div className={s.terminal}>
        ...
        <DottedDiv className={s.content}>
          <p ref={contentRef}>Do Coding Hard...</p>
          <button
            title="copy text"
...
const socials = [
  {
    name: "github",
    url: "https://github.com/arunsingh2004/",
  },
];
